...
export default function RefundPolicy() {
  ...
  const sections = t('refundPolicy.sections', { returnObjects: true }) as PolicySection[]
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="font-heading text-xl font-bold text-text mb-2">
                {t('refundPolicy.highlight.title')}
              </h2>
              <p className="text-text-secondary">{t('refundPolicy.highlight.description')}</p>
            </div>
          </div>
        </Card>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-heading text-lg font-bold text-text mb-2">
                    {t('refundPolicy.questions.title')}
                  </h3>
